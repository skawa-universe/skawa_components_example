...
@Task('compile scss')
Future sass() async {
  ang.config.sassBuildConfig.package = 'skawa_components_example';
...
Future checkimport() async {
  ang.config.importOptimize.packagesToCheck = ['skawa_components, skawa_components_example'];
  await ang.checkImport();
}

@Task('watch scss')
Future sasswatch() async {
  ang.config.sassWatchConfig.package = 'skawa_components_example';
